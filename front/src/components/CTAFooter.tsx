...
export default function CTAFooter() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#FFE4D3]/30 via-[#EEE6FF]/30 to-[#E8E5FF]/20"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-[#FFF3EC]/40 via-[#E8E5FF]/20 to-transparent"></div>
      <div className="absolute inset-0 bg-gradient-to-l from-[#E6E4FF]/20 via-transparent to-[#E6E4FF]/20"></div>

...
export default function MontanaSection({
  ...
  return (
    <section ref={sectionRef} className="relative w-full min-h-[90vh] md:min-h-[110vh] flex items-center justify-center overflow-hidden">
      {/* Background image */}
      <div
      ...
      <div ref={inViewRef} className="relative z-10 flex flex-col items-center justify-center w-full max-w-[2100px] mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-end items-center w-full">
            <button
              className="px-8 py-3 rounded-md font-semibold text-base border transition min-w-[180px]"
              style={{
                color: "#00D481",
                borderColor: "#00D481",

...
export default function ClubDealsSection() {
  ...
  return (
    <section className="w-full bg-[#f7f7f7] pt-12 pb-24" ref={sectionRef}>
...
<p className="text-lg text-gray-600 mb-8">
  Accédez à des opportunités d'investissement exclusives dans l'immobilier premium. Nos Club Deals vous permettent de participer à des projets soigneusement sélectionnés avec un potentiel de rendement attractif.
</p>

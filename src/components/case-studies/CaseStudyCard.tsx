...
export default function CaseStudyCard({ study }: { study: CaseStudyDoc }) {
  ...
  return (
    <Link
      href={study.url}
      className="group block rounded-lg border border-gray-200 overflow-hidden transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/60 hover:shadow-lg hover:border-gray-300"

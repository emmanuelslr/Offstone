...
export default function TextRevealMethode({ 
      ...
      <section className={`w-full ${backgroundColor} z-30`}>
        <div className="max-w-[800px] mx-auto px-2 py-10 md:py-14">
          <motion.div
            ...
            className={`text-3xl md:text-4xl lg:text-[2.8rem] text-center font-light tracking-tight leading-tight ${className}`}
    ...
    <section className={`w-full ${backgroundColor} z-30`}>
      <div className="max-w-[1000px] mx-auto px-2 py-12 md:py-16">
        <motion.div
          ...
          transition={{ duration: 0.8, ease: [0.77, 0, 0.18, 1] }}
          viewport={{ once: true, amount: 0.5 }}
                      className={`text-3xl md:text-4xl lg:text-[2.8rem] text-center font-light tracking-tight ${className}`}
          style={{ fontFamily: 'AllianceNo1-Regular, sans-serif' }}
        >
          {letters.map((char, i) => (
            <span
